...
export default function SecondSection() {
    ...
    return (
        <Box my={12} pb={6} sx={{ background:`linear-gradient(to bottom,#F2F5FA,#9e9e9e)`,backgroundPosition: 'center', backgroundRepeat: 'no-repeat',backgroundSize: 'cover',position: 'relative'}}>
            <Box my={12} mx={6}>
