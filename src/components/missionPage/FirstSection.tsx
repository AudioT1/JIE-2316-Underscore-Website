...
export default function FirstSection() {
    ...
    return (
        <Box sx={{ backgroundImage: 'url(/missionpageImage.png)',height: 650,backgroundPosition: 'center', backgroundRepeat: 'no-repeat',backgroundSize: 'cover',position: 'relative'}}>
             <Box textAlign="left" bgcolor="rgba(255,255,255,.50)" px={10} py={smallScreen? 10:5} mt={smallScreen? "360px": medScreen? "380px":"360px"} position="absolute" width="100%" >
